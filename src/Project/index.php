          ...
          <?php while ($item_row = $item_result->fetch_assoc()): ?>
            <div
              ...
              <div class="w-full md:w-1/2 p-4 text-center md:text-left" data-aos="fade-right">
                ...
                <a href="<?php echo $item_row['pd_link']; ?>" target="_blank">
                  <button
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
          ...
          <div class="w-full">
            <div class="w-full h-80 sm:h-[28rem] md:h-[30rem] lg:h-[34rem] rounded-xl overflow-hidden shadow-lg">
              <iframe class="w-full h-full rounded-lg" src="https://www.youtube.com/embed/w_VQJBWvJcI?autoplay=1&mute=1"
...
<section class="py-16 px-4 sm:px-6 lg:px-8 bg-green-50" id="contact">
  <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <!-- Right: Contact Form -->
    <form action="" method="POST" class="bg-white shadow-xl rounded-2xl p-8 space-y-6">
      <!-- Flash message display -->
      <?php if ($successMessage || $errorMessage): ?>
        <div id="flash-message"
          class="<?= $successMessage ? 'text-green-700 bg-green-100 border-green-300' : 'text-red-700 border-red-300' ?> border p-3 rounded-md">
